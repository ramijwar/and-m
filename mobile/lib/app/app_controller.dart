...
final class AppController extends ChangeNotifier {
  ...
  Stream<NotificationTarget> get notificationTargets =>
      _notificationTargets.stream;
  ...
  PushDeviceRegistrationState pushDeviceRegistrationState =
      PushDeviceRegistrationState.notRegistered;
  ...
  Future<void> loadStoreDirectory({
    ...
    if (!force &&
        !isStoreDirectoryLoading &&
        storeDirectoryMode == normalizedMode &&
        storeDirectory.isNotEmpty) {
      return;
    }
  ...
  Future<List<Map<String, dynamic>>> loadMerchantOrders({String status = ''}) =>
      _workspaceRepository.merchantOrders(status: status);

  Future<void> transitionMerchantOrder({
    required String orderId,
    required String action,
  }) => _workspaceRepository.transitionMerchantOrder(
    orderId: orderId,
    action: action,
  );
  ...
  }) => _workspaceRepository.cancelMerchantOrder(
    orderId: orderId,
    reason: reason,
  );
  ...
  Future<CatalogPage<StoreSummary>> browseStoresPage({
    ...
    String sort = 'popular',
    int page = 1,
  }) => _catalogRepository.browseStoresPage(
    search: search,
  ...
  }) => _catalogRepository.setStoreFollowing(
    storeId: storeId,
    following: following,
  );
  ...
  Future<CatalogPage<MarketplaceListing>> browseMarketplacePage({
    ...
    String sort = 'newest',
    int page = 1,
  }) => _catalogRepository.browseMarketplacePage(
    search: search,
    city: city,
    categoryId: categoryId,
    sort: sort,
  ...
  Future<List<Map<String, dynamic>>> loadConversationMessages(
    ...
    final messages = await _catalogRepository.loadConversationMessages(
      conversationId,
    );
  ...
  Future<List<Map<String, dynamic>>> loadAdminSupportTickets() =>
      _workspaceRepository.adminSupportTickets();

  Future<Map<String, dynamic>> loadAdminSupportTicket(String ticketId) =>
      _workspaceRepository.adminSupportTicket(ticketId);
  ...
  Future<Map<String, dynamic>> loadAdminStoreDetail(String storeId) =>
      _workspaceRepository.adminStoreDetail(storeId);
  ...
  Future<List<Map<String, dynamic>>> loadAdminMarketplaceListings({
    String status = '',
    String search = '',
  }) => _workspaceRepository.adminMarketplaceListings(
    status: status,
    search: search,
  );
  ...
  }) => _workspaceRepository.updateAdminMarketplaceListing(
    listingId: listingId,
    values: values,
  );
  ...
  Future<void> attachAdminMarketplaceListingMedia({
    required String listingId,
    required XFile image,
  }) => _workspaceRepository.attachAdminMarketplaceListingMedia(
    listingId: listingId,
    image: image,
  );
  ...
  Future<void> updateAdminStore({
    ...
    required Map<String, dynamic> values,
    XFile? logo,
  }) => _workspaceRepository.updateAdminStore(
    storeId: storeId,
    values: values,
    logo: logo,
  );

  Future<List<Map<String, dynamic>>> loadStoreBanners({required bool admin}) =>
      admin
  ...
  Future<void> saveStoreBanner({
    ...
    required Map<String, dynamic> values,
    XFile? image,
  }) => _workspaceRepository.saveStoreBanner(
    admin: admin,
    bannerId: bannerId,
    values: values,
    image: image,
  ...
  Future<void> deleteStoreBanner({
    ...
    required String bannerId,
      ...
      _workspaceRepository.deleteStoreBanner(admin: admin, bannerId: bannerId);
  ...
  Future<List<Map<String, dynamic>>> loadAdminAuditLogs({String search = ''}) =>
      _workspaceRepository.adminAuditLogs(search: search);
  Future<List<Map<String, dynamic>>> loadAdminNotificationLogs({
    String search = '',
    String category = '',
    String deliveryStatus = '',
  }) => _workspaceRepository.adminNotificationLogs(
    search: search,
    category: category,
  ...
  searchMerchantNotificationCampaignProducts({String search = ''}) =>
  ...
  Future<List<Map<String, dynamic>>> loadAdminMerchantNotificationCampaigns({
    String status = '',
  ...
  Future<Map<String, dynamic>> reviewMerchantNotificationCampaign(
    String campaignId,
    Map<String, dynamic> values,
  ) => _workspaceRepository.reviewMerchantNotificationCampaign(
    campaignId,
    values,
  );
  Future<List<Map<String, dynamic>>> searchAdminNotificationCampaignTargets({
    ...
    String storeId = '',
  }) => _workspaceRepository.adminNotificationCampaignTargets(
    type: type,
    search: search,
    storeId: storeId,
  );
  ...
  Future<Map<String, dynamic>> loadAdminFinancialSummary({
    String currencyCode = '',
  }) => _workspaceRepository.adminFinancialSummary(currencyCode: currencyCode);
  Future<List<Map<String, dynamic>>> loadAdminFinancialWallets({
    String search = '',
    String currencyCode = '',
    String ownerType = '',
  }) => _workspaceRepository.adminFinancialWallets(
    search: search,
    currencyCode: currencyCode,
    ownerType: ownerType,
  );
  Future<Map<String, dynamic>> loadAdminFinancialWalletDetail(
    String accountKey,
    String currencyCode,
  ) =>
      _workspaceRepository.adminFinancialWalletDetail(accountKey, currencyCode);
  Future<List<Map<String, dynamic>>> loadAdminFinancialEntries({
    String search = '',
    String currencyCode = '',
    String direction = '',
    String entryType = '',
  }) => _workspaceRepository.adminFinancialEntries(
    search: search,
    currencyCode: currencyCode,
    direction: direction,
    entryType: entryType,
  );
  Future<List<Map<String, dynamic>>> loadAdminFinancialInvoices({
    String search = '',
    String currencyCode = '',
  }) => _workspaceRepository.adminFinancialInvoices(
    search: search,
    currencyCode: currencyCode,
  );
